...
export function TopBar({ title, iconUrl, live, offset, watching, preview }: { title: string; iconUrl: string | null; live: boolean; offset: number; watching: number; preview: boolean }) {
  return (
