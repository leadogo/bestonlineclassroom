...
export async function ModSeat({ slug, date }: { slug?: string; date?: string }) {
  ...
  return (
    <ModView
      ...
      event={{ slug: event.slug, title: event.title, iconUrl: event.icon_url, hostName: event.host_name, videoUrl: event.video_url, ctaAt: event.cta_at_seconds, katherine: event.katherine_enabled }}
