...
const PROFANITY = /\b(fuck\w*|shit\w*|bitch\w*|asshole\w*|bastard|cunt\w*|dick\w*|pussy|cock\w*|motherfuck\w*|nigg\w*|fag\w*|retard\w*|whore\w*|slut\w*|damn|goddamn|wtf|stfu)\b/i;
...
export function checkMessage(body: string): FilterVerdict {
  ...
  if (LINK.test(text)) return { ok: false, kind: "link", reason: "Links can't be shared in the chat." };
