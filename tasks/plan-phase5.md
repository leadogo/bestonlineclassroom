# Plan: phase 5 (draft, awaiting confirmation of SPEC-phase5.md)
...
- [ ] F3 Moderator/admin message URLs clickable, new tab, attendee rendering unchanged.
...
- [ ] R2 Crowd reactions on real messages behind `events.crowd_reactions_enabled`, test-run first.
