...
Status: **answered 2026-09-21 evening** (review page: https://claude.ai/artifact/CrNrgCkWPy7vn8mVHK64Mp; desk before/after render: https://claude.ai/artifact/2mmpEwA3FxVrSjAonmQhaJ). William answered yes to Q1–Q11, Q13–Q15, Q17 as recommended; **Q12 (crowd reactions on real messages) is dropped.** 5.0 through 5.3 built and deployed by 2026-09-22 ~00:30 MT (William asked for one big test instead of phase by phase). Katherine and the crowd curve are per-event switches, on for test-run only until he decides. "Starting soon" kept by William, the rest of the wording per Jeremy.
